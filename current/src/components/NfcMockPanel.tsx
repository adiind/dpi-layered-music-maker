    ...
    <div className="grid gap-3 md:grid-cols-4">
      {LAYER_DEFINITIONS.map((layer) => (
        ...
        >
          ...
          <div className="grid h-10 w-10 place-items-center rounded-full border border-[#e8eaed] bg-white text-[13px] font-semibold text-[#202124] transition group-hover:border-[#dadce0]">
            {layer.order}
          </div>
        </button>
      ))}
